...
| Accessor | Called from | Notes |
|---|---|---|
| `content()` | `Interaction-async.tsx:96,103`, `SelfInvocation.tsx`, `Return.tsx:34`, `StylePanel.tsx:242` (duck-typed) | Label text + `[start.start, stop.stop]` selection range. |
...
|---|---|
| `getFormattedText()` | Interaction-async.tsx:96,100; SelfInvocation.tsx; FragmentSection.tsx:30; FragmentRef.tsx:19; ConditionLabel.tsx:23; FragmentTryCatchFinally.tsx:31; LifeLineGroup.tsx:137; ParticipantStylePanel.tsx:137; participantStyleTransform.ts:28,42,44,45,46,52; AsyncMessageStatementVM.ts:28; ReturnStatementVM.ts:24 |
...
| `content()` (async) | Interaction-async.tsx:96,103; SelfInvocation.tsx; Return.tsx:34; StylePanel.tsx:242 |
