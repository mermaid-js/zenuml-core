...
== Build
This project is built with Vite + Bun. It has two types of target: the web application and the library.
...
The demo pages^1^ are built with Vite. On the page, there needs to be a `pre`
