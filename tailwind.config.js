  ...
  theme: {
    extend: {
      colors: {
        skin: {
          frame:
            "rgb(var(--color-bg-frame, var(--color-bg-canvas, var(--color-bg-base, 255 255 255))))",
        },
      },
      textColor: {
        skin: {
          ...
          "message-hover":
            "rgb(var(--color-text-message-hover, var(--color-bg-base, 255 255 255)))",
          comment:
      ...
      backgroundColor: {
        skin: {
          canvas:
            "rgb(var(--color-bg-canvas, var(--color-bg-base, 255, 255, 255))",
          frame:
            "rgba(var(--color-bg-frame, var(--color-bg-canvas, var(--color-bg-base, 255 255 255))), <alpha-value>)",
          title:
            "rgb(var(--color-bg-title, var(--color-bg-frame, var(--color-bg-canvas, var(--color-bg-base, 255 255 255)))))",
          participant:
            "rgb(var(--color-bg-participant, var(--color-bg-frame, var(--color-bg-canvas, var(--color-bg-base, 255 255 255)))))",
          lifeline:
          ...
          occurrence:
            "rgb(var(--color-bg-occurrence, var(--color-bg-participant, var(--color-bg-frame, var(--color-bg-canvas, var(--color-bg-base, 255 255 255))))))",
