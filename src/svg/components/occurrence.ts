...
export function renderOccurrence(o: OccurrenceGeometry): string {
  ...
  return `<rect x="${o.x + strokeHalf}" y="${o.y + strokeHalf}" width="${o.width - strokeHalf * 2}" height="${o.height - strokeHalf * 2}" class="occurrence" data-participant="${esc(o.participantName)}"/>`;
}
