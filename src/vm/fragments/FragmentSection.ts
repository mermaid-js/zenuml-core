...
export class FragmentSection extends FragmentVM {
  /**
   * Section fragment knows exactly how to collect its own statements
   * Simple fragment with just statements array
   */
  getStatements(): IRStatement[] {
    const statements: IRStatement[] = [];
    
    // Section fragment is simple - just has statements array
